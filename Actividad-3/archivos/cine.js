document.addEventListener('DOMContentLoaded', () => {
  ...
  fetch('archivos/cartelera.json') // Asumiendo que cartelera.json está en assets/js/
    .then(response => {
      if (!response.ok) {
        ...
        tarjeta.innerHTML = `
          <div class="card h-100 text-center">
            ...
            <div class="card-body d-flex flex-column style="padding-top: 1.5rem;">
              ...
              <a href="${pelicula.enlace}" class="btn btn-danger mt-auto" target="_blank">Comprar entrada</a>
            </div>
          </div>
        `;
